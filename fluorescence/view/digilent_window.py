...
class DAQWindow(QMainWindow, BaseView):
    ...
    def __init__(self, experiment):
        ...
        self.button_start_saving.clicked.connect(self.experiment.start_saving_daq_and_images)
        self.button_stop_saving.clicked.connect(self.experiment.stop_saving_daq_and_images)
